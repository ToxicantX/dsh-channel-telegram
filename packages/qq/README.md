...
QQ official Bot API v2 C2C transport used by dsh-channel-telegram. It provides access-token refresh, Gateway identify/resume/heartbeat/reconnect, allowlisted C2C commands, numbered menus, progress replies, and bounded event de-duplication.
...
Publish npm packages in dependency order: `@wsxcant/dsh-channel-telegram-gateway@0.2.2`, `@wsxcant/dsh-channel-qq@0.1.0`, then `dsh-channel-telegram@0.3.0`.
